...
parser.add_argument("-l","--loggingfreq", help="Logging Frequency (default 1000)", type=int, default=1000)


args = parser.parse_args()

if args.outfile == "":
	outfile = string.replace(args.outfile, "react", "csv") if "react" in args.infile else args.infile+".csv"
else:
	outfile = args.outfile

p = Parser()
model = p.get_model(args.infile, outfile)
model.iterate()
